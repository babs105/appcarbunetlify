    ...
    render() {
        ...
        return (
            ...
            <Grid item md={6} sm={12} xs={12}>
             ...
             <Typography variant="h4" style={{ display: 'flex',justifyContent:'center' ,marginBottom:'30px'}} >Rajout cuve</Typography>
                <form >
                                ...
                                <Select  
                                   ...
                                   {this.state.stations.map((dt, i) =>  (
                                    <MenuItem
                                        ...
                                        key={i} name={dt.stationName}>{dt.stationName}
                                    </MenuItem>     
                                ))
                            }
                                  </Select>
            ...
            <Grid container justify='center' alignItems="center" style={{ marginTop: '30px' }}>
                        ...
                        <Button variant="contained"  color="primary" fullWidth onClick={this.rajouterCuve} >Valider</Button>
                        </Grid>
